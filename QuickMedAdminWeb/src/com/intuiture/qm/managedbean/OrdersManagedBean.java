...
//
//import com.intuiture.storetodoorgrocer.bean.OrdersBean;
//import com.intuiture.storetodoorgrocer.json.AddToCartJson;
...
//		try {
//			String[] searchFieldLabels = { "OrderId", "Phone Number", "Customer Name" };
//			String[] searchFieldValues = { "totalOrderGenId", "customerDeliveryAddress.phoneNumber", "customer.fullName" };
...
//				getGridInfoJson().setLocationId(loginManagedBean.getSelectedLocation());
//			}
...
//		try {
//			Double subTotal = 0d;
//			for (AddToCartJson json : getTotalOrdersJson().getOrdersList()) {
